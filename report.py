...
process1 = subprocess.Popen(['python', './A_star_algorithm.py'], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
process2 = subprocess.Popen(['python', './A_star_algorithm.py'], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
process3 = subprocess.Popen(['python', './Backtrack_algorithm.py'], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
wins_Astar = 0
losses_Astar = 0
wins_bt = 0
losses_bt = 0
...
def mapgen():
    ...
    process1 = subprocess.Popen(['python', './A_star_algorithm.py'], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
    process2 = subprocess.Popen(['python', './A_star_algorithm.py'], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
    process3 = subprocess.Popen(['python', './Backtracking_algorithm.py'], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)
